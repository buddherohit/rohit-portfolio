  ...
  return (
    <div className="relative isolate bg-gradient-to-b from-white via-gray-50 to-white dark:from-slate-950 dark:via-slate-950 dark:to-slate-900/30 py-16 sm:py-20 overflow-hidden">
      ...
      <div className="text-center mb-12 relative z-10">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold mb-3 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-red-600 to-gray-900 dark:from-slate-100 dark:via-red-500 dark:to-slate-100">
          Education Journey
        </h2>
      ...
      >
        {/* Vertical Line */}
        <div className="absolute left-4 sm:left-8 top-4 bottom-4 w-0.5 bg-gradient-to-b from-gray-200 via-red-200 to-gray-200 dark:from-slate-800 dark:via-red-950/30 dark:to-slate-800" />
          ...
          {EDUCATION_DATA.map((edu, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content Card */}
                <div
                  className="group relative bg-white dark:bg-slate-900/60 rounded-2xl p-5 sm:p-7 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-800 hover:border-red-100 dark:hover:border-red-950"
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-1">
                          <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-slate-100 group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors">
                            {edu.degree}
                          </h3>
                          <span className="px-3 py-1 text-xs font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/20 rounded-full border border-red-100 dark:border-red-950">
                            {edu.year}
                          </span>
                        </div>
                        ...
                        <div className="text-sm text-gray-500 dark:text-slate-400 flex items-center gap-1.5">
                          <span className="font-semibold text-gray-900 dark:text-slate-200">{edu.shortInst}</span>
                    ...
                    <div className="mb-5 pl-0 sm:pl-[72px]">
                      <div className="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 dark:text-slate-400 mb-3">
                      ...
                      <div className="bg-gray-50 dark:bg-slate-950/40 rounded-xl p-3 border border-gray-100 dark:border-slate-800">
                        <div className="flex items-center justify-between text-xs font-medium text-gray-600 dark:text-slate-400 mb-2">
                          <span className="flex items-center gap-1.5">
                            <TrendingUp className="w-3.5 h-3.5 text-red-500" />
                            Status: <span className={edu.progress === 100 ? "text-green-600 dark:text-green-500" : "text-blue-600 dark:text-blue-500"}>{edu.status}</span>
                          </span>
